...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-12-2021 a las 23:07:24
...
ALTER TABLE `users`
  ...
  ADD KEY `fk_users_estado_usuario1_idx` (`estado_usuario_id`);
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `fk_users_estado_usuario1` FOREIGN KEY (`estado_usuario_id`) REFERENCES `estado_usuario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
