...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-12-2021 a las 22:15:40
...
--
DROP DATABASE IF EXISTS `proyectoformativo`;
...
INSERT INTO `categoria` (`id_categoria`, `nombre_categoria`, `estado_a_i_id`) VALUES
...
--
-- Estructura de tabla para la tabla `estado_a_i`
--

CREATE TABLE `estado_a_i` (
  `id` int(11) NOT NULL,
  `estado` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `estado_a_i`
--

INSERT INTO `estado_a_i` (`id`, `estado`) VALUES
(1, 'activo'),
(2, 'inactivo');
...
INSERT INTO `fidelizacion` (`id`, `nombre`) VALUES
(1, 'bronce');
...
INSERT INTO `marcas` (`id`, `nombre_marcas`, `estado_a_i_id`) VALUES
(1, 'xiaom', 1),
(2, 'samsung', 1);
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `created_at`, `updated_at`, `tipos_id_tipo`, `documento`, `fidelizacion_id`, `telefono`, `estado_a_i_id`) VALUES
(2, 'hernando', 'hernando@hotmail.com', '$2y$10$rfha1RFlBQHzKrNW66H6guTymkyJs0MPA9O0YOf1bj62D11QGqwUW', '2021-12-03 00:08:26', '2021-12-03 00:08:26', 4, NULL, 1, NULL, 0);
...
ALTER TABLE `categoria`
  ...
  ADD KEY `fk_categoria_estado_A_I1_idx` (`estado_a_i_id`);
...
--
-- Indices de la tabla `estado_a_i`
--
ALTER TABLE `estado_a_i`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `marcas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_marcas_Estado_A_I1_idx` (`estado_a_i_id`);
...
ALTER TABLE `users`
  ...
  ADD KEY `fk_users_fidelizacion1_idx` (`fidelizacion_id`),
  ADD KEY `fk_users_Estado_A_I1_idx` (`estado_a_i_id`);
...
--
-- AUTO_INCREMENT de la tabla `estado_a_i`
--
ALTER TABLE `estado_a_i`
...
--
ALTER TABLE `subcategoria`
  MODIFY `id_subcategoria` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `categoria`
  ADD CONSTRAINT `fk_categoria_estado_A_I1` FOREIGN KEY (`estado_a_i_id`) REFERENCES `estado_a_i` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `marcas`
  ADD CONSTRAINT `fk_marcas_Estado_A_I1` FOREIGN KEY (`estado_a_i_id`) REFERENCES `estado_a_i` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `fk_users_Estado_A_I1` FOREIGN KEY (`estado_a_i_id`) REFERENCES `estado_a_i` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_users_fidelizacion1` FOREIGN KEY (`fidelizacion_id`) REFERENCES `fidelizacion` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_users_tipos1` FOREIGN KEY (`tipos_id_tipo`) REFERENCES `tipos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
