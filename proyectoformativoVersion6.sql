...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-03-2022 a las 03:40:27
...
INSERT INTO `direccion` (`id_direccion`, `direccion`, `barrio`, `id_usuario`, `id_municipio`) VALUES
(1, 'carrera 27 e 83-51', 'alfonso', 3, 150),
(2, 'carrera 4 c #29-50', 'almendros', 3, 639);
...
INSERT INTO `pedidos` (`id_pedidos`, `id_direccion`, `fecha_pedido`, `valor_total_factura`, `num_factura`, `fecha_fact`, `estado`) VALUES
(1, 1, '2022-02-24', 679184, NULL, '2022-02-24', '1'),
(2, 2, '2022-02-23', 200000, NULL, '2022-02-23', '1');
...
--
-- Volcado de datos para la tabla `pedido_x_producto`
--

INSERT INTO `pedido_x_producto` (`id_pedido_x_producto`, `id_pedido`, `id_producto`, `cantidad`, `valor_producto_venta`) VALUES
(1, 1, 100, 16, 3184),
(2, 1, 101, 4, 676000);
...
(100, 1, 'Altavoz Inteligente ', 199, 2, 'Tipo: Parlantes inalambricos Potencia RM', 'https://bluetransporte.com/184/img/100.jpg', 3, 0, 0, 3, NULL),
(101, 1, 'Parlante Bluetooth S', 169000, 8, 'Tipo	Parlantes port?tiles Potencia RMS	1', 'https://bluetransporte.com/184/img/101.jpg', 3, 0, 0, 3, NULL),
(102, 1, 'Asistente de Voz Go', 149, 1, 'Tipo	Parlantes inal?mbricos Potencia RMS', 'https://bluetransporte.com/184/img/102.jpg', 3, 0, 0, 3, NULL),
(103, 1, 'Kit hikvision dvr 4 ', 820, 5, 'Marca	HIKVISION Modelo	dvr4 Tipo	Segurid', 'https://bluetransporte.com/184/img/103.jpg', 3, 0, 0, 3, NULL),
(104, 1, 'Mi 360 Home Security', 2490000, 4, 'Megap?xeles	1296 Sensibilidad ISO	ISO Au', 'https://bluetransporte.com/184/img/104.jpg', 3, 0, 0, 3, NULL),
(105, 1, 'Cerradura Digital de', 2028500, 5, 'Marca	Yale Modelo	YMF40 Tipo	Seguridad/ ', 'https://bluetransporte.com/184/img/105.jpg', 3, 0, 0, 3, NULL),
...
(109, 1, 'Lavadora Secadora Sa', 4999900, 5, '(AltoxAnchoxProfundidad)	98.4 x 68.6 x 7', 'https://bluetransporte.com/184/img/109.jpg', 3, 0, 0, 3, NULL),
...
(112, 1, 'Bombillo inteligente', 189900, 5, 'Marca	WiZ Modelo	RGB (16 millones de col', 'https://bluetransporte.com/184/img/112.jpg', 3, 0, 0, 3, NULL),
...
(202, 1, ' Juego De Cubiertos', 45, 1, '6 Tenedores de mesa/comida 6 Cuchillos d', 'https://bluetransporte.com/184/img/202.png', 3, 0, 0, 3, NULL),
...
CREATE TABLE `trabajadores` (
  ...
  `punto_fidelizacion` int(30) DEFAULT NULL,
...
INSERT INTO `trabajadores` (`id`, `name`, `apellido_usuario`, `celular`, `usuario`, `contrasena`, `punto_fidelizacion`, `documento`, `email`, `created_at`, `updated_at`, `tipos_id_tipo`, `id_estado`) VALUES
(1, 'diana cardona', NULL, 31872546, 'dinacard', '123456', 1, '1143855074', '31872546', '2022-03-01', '2022-03-01 15:07:56', 3, 2),
(2, 'daniel', 'null', 3218, 'null', 'null', NULL, '13354', '3218', NULL, NULL, 3, 2),
(3, 'laila narvaez', 'null', 3158774, 'null', 'null', NULL, '1145845', 'laila@hotmail.com', NULL, NULL, 3, 1),
(4, '#1', 'null', 94, 'null', 'null', NULL, '94', '123', NULL, NULL, 3, 1);
...
(5, 'Luis Alberto Quintero', 'luismi905@hotmail.com', '$2y$10$Y.yBpm7M0ju5Wc3ljYYPN.hXq349gAb11F0r7DwrPN8yMFxFPLEA2', '2022-02-23 00:02:03', '2022-02-23 00:02:03', 4, NULL, 1, NULL, NULL),
(7, 'Diana Mera', 'diana@misena.edu.coc', '12345678', '2022-02-25 19:24:42', '2022-02-25 19:24:42', 3, '1144159785', 1, '3120555221', '1'),
(8, 'Jose Ignacio Garcia', 'nachibig@hotmail.com', '$2y$10$vjkVIgazFEhvvEgQ/DO3U.ylsGAQqmOwwnu7Kr4kFWvomENH1en2G', NULL, NULL, 4, '1144134316', 1, NULL, '1'),
(9, 'erika', 'edominguez@hotmail.com', '$2y$10$WRg1/GNqFPDZh45oMNE7k.TZ4Wp46qPOX3EyTwcr7pchrjRyOb1DS', '2022-03-02 03:50:26', '2022-03-02 03:50:26', 4, NULL, 1, NULL, NULL);
...
ALTER TABLE `trabajadores`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_users_estado1` (`id_estado`);
...
--
ALTER TABLE `pedidos`
  MODIFY `id_pedidos` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `pedido_x_producto`
--
ALTER TABLE `pedido_x_producto`
  MODIFY `id_pedido_x_producto` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
